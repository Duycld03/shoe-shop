        ...
        <div class="hidden md:mx-28 md:flex -mt-20 mb-16">
            <c:forEach items="${top3DiscountedProduct}" var="product">
                <div class="md:relative w-1/3 hover:cursor-pointer"
                     onclick="redirectToDetailPage('${product.productId}')">
                    ...
                    <div
                        class="absolute bottom-4 flex items-center text-lg space-x-2 right-1/2 translate-x-1/2">
                    ...
                    <div onclick="redirectToDetailPage('${product.productId}')"
                        ...
                        <div class="md:mx-10 mx-4 mt-4 mb-6 space-y-4">
                            ...
                            <div class="flex justify-between items-center">
                                <div>
                                    <span class="text-[#40BFFF] font-bold text-lg">$${product.price -
                                                                                      product.price
                                ...
                                <div class="flex flex-col md:flex-row">
                                    ...
                                    <span
                                        class="text-[#FB7181] font-bold text-sm md:text-base">${product.discount}%
                                        Off</span>
                                </div>
                            </div>
                        </div>
