		...
		if (request.getParameter("btnForgot") != null) {
			...
			if (customer != null || staff != null || admin != null) {
				...
				try {
					...
					sb.append(
							"You are receiving this email because you requested to reset your password for your account on Shoes Store. <br> ");
					sb.append("Please click on the link below to reset your password:. <br> ");
					sb.append(url + ". <br> ");
					sb.append(
							"If you did not request to reset your password, you can safely ignore this email. Your account will remain unaffected.. <br> ");
