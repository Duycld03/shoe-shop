...
public class GoogleRegisterController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession().getAttribute("user") != null) {
            request.getRequestDispatcher("/Customer/googleRegister.jsp").forward(request, response);
        } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("btnRegister") != null) {
            ...
            Customer customer = new Customer(customerId, username, password, user.getEmail(), user.getName(),
