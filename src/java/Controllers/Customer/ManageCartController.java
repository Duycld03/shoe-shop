...
public class ManageCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // out.println(" <li class=\"d-flex justify-content-between py-3
        // border-bottom\"><strong class=\"text-muted\">Tá»•ng tiá»�n
        // hĂ ng</strong><strong>" + totalMoney + "</strong></li>\r\n"
        // + " <li class=\"d-flex justify-content-between py-3 border-bottom\"><strong
        // class=\"text-muted\">PhĂ­ váº­n chuyá»ƒn</strong><strong>Free
        // ship</strong></li>\r\n"
        // + " <li class=\"d-flex justify-content-between py-3 border-bottom\"><strong
        // class=\"text-muted\">VAT</strong><strong>10 %</strong></li>\r\n"
        // + " <li class=\"d-flex justify-content-between py-3 border-bottom\"><strong
        // class=\"text-muted\">Tá»•ng thanh toĂ¡n</strong>\r\n"
