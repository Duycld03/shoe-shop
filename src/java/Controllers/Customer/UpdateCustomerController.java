...
public class UpdateCustomerController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("btnSave") != null) {
			...
			if (!customer.getEmail().equals(semail) && (customerDAO.getByEmail(semail) != null
			...
			if (!customer.getPhoneNumber().equals(sphonenumber)
			...
			if (!customer.getUsername().equals(susername) && (customerDAO.getCustomerByUsername(susername) != null
