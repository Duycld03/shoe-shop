...
public class AddProductManagement extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/Manager/addNewProduct.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("btnSave") != null) {
            ...
            try {
                ...
                Product pro = new Product(ProID, productName, price_draw, discount_draw, description, brandId,
                        isDeleted);
