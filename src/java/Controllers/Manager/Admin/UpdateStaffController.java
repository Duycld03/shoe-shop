...
public class UpdateStaffController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/Manager/Admin/updatestaff.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("btnSave") != null) {
            ...
            if (!staff.getUsername().equals(susername) && (customerDAO.getCustomerByUsername(susername) != null
