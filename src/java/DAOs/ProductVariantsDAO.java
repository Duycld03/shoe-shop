...
public class ProductVariantsDAO {
    ...
    public List<Integer> getSizeByProID(String ID) {
        List<Integer> vars = new ArrayList<>();
        String sql = " Select Size from ProductVariants\n"
    ...
    public static void main(String[] args) {
        ...
        List<Integer> vars = dao.getSizeByProID("P10");
