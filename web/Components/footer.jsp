...
<footer class="bg-[#BCDDFE] md:px-32 py-16 md:pt-36 md:pb-14 px-4">
    <div class="grid md:grid-cols-3 md:gap-80 mb-8 md:mb-16 grid-cols-1 gap-8">
        ...
        <div>
            <p class="text-lg font-medium md:mb-5 mb-2">Follow Us</p>
            <p class="text-xs md:mb-5 mb-2">Since the 1500s, when an unknown printer took a galley of type and
                scrambled.
            </p>
        ...
        <div>
            <p class="text-lg font-medium md:mb-5 mb-2">Contact Us</p>
            <p class="text-sm mb-5">Shoe Store , Ninh Kieu Can Tho</p>
        </div>
    </div>
