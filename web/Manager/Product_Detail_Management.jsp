            ...
            <main>
                <div class="container mt-3 pt-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-8">
                            <h5 class="mb-0 text-left text-lg">
                                <input type="text" readonly="" class="form-control text-xl"
                                       value="THESE ARE PRODUCT DETAIL INFORMATION OF ${pro.productName}">
                        </h5>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 mb-3">
                        ...
                        <div class="text-left mb-3">
                            <a href="/Manager/addVariant.jsp?ProID=${pro.productId}" class="btn btn-success"
                               data-toggle="modal">
                                    ...
                                    <td>
                                        <div class="btn-group d-flex align-items-center">
                                            ...
                                            <c:if test="${var.isDelete() eq false}">
                                                <button class="btn btn-warning" onclick="messageConfirm('Delete this variant', () => {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <div class="btn-group">
                                                <button class="btn btn-info"
                                                        onclick="location.href = '/updateimage?ImgID=${img.getImageId()}&&proid=${pro.productId}'">
                                                    <i class="material-icons" data-toggle="tooltip"
                                                       title="Edit">&#xE254;</i>
                                                </button>
                                                &nbsp;&nbsp;&nbsp;
                                                <button class="btn btn-warning" onclick="messageConfirm('Delete this image', () => {
