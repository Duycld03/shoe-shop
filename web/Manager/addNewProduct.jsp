<%-- Document : addNewProduct Created on : Mar 6, 2024, 1:33:06 PM Author : Doan Thanh Phuc - CE170580 --%>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input name="productName" type="text" class="form-control"
                                            value="${c.productName}" required>
                                        <div class="text-warning">${NameError}</div>
                                    </div>
                                    <div class="form-group">
                                        <label>Price</label>
                                        <input name="price" min="1" type="number" class="form-control"
                                            value="${c.price}" required title="Price must contain 10 digits">
                                    </div>
                                    <div class="form-group">
                                        <label>Discount</label>
                                        <input name="discount" min="0" type="number" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="description" type="text" value="${c.description}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="brandID" class="form-control">
                                            <c:forEach var="brand" items="${requestScope.Brands}">
                                                <option value="${brand.brandId}" ${(c.brandId eq brand.brandId)
                                                    ? 'selected' : '' }>${brand.brandId}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
