<%-- Document : productList Created on : Mar 5, 2024, 7:40:18 PM Author : Doan Thanh Phuc - CE170580 --%>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group d-flex justify-content-center align-items-center">
                                    <button class="btn btn-info" onclick="location.href = 'updateproduct?ProID=${c.productId}'">
                                        <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                    </button>
                                    <c:if test="${c.getIsDelete() eq false}">
                                        &nbsp;&nbsp;&nbsp;
                                        <button class="btn btn-warning" onclick="messageConfirm('Delete this product', () => {
