<%-- Document : updatebrand Created on : Mar 5, 2024, 2:53:12 PM Author : To Do Hong Y - CE171148 --%>
                    ...
                    <form action="loadBrand" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="brandname" type="text" class="form-control" value="${c.brandName}"
                                       required pattern="[a-zA-Z]+" title="Brand name must contain only letters">
                            </div>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                closeModalButtons.forEach(function (button) {
                    button.addEventListener("click", function () {
                        ...
                        // Chuyển hướng về trang brandmanager
