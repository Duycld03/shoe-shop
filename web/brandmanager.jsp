<%-- 
    Document   : brandmanager.jsp
    Created on : Mar 5, 2024, 2:21:02 PM
                ...
                <div class="container mt-3 pt-4">
                    ...
                    <c:forEach items="${requestScope.data}" var="c">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <button class="btn btn-warning" onclick="location.href = 'loadBrand?id=${c.brandId}'">
                    ...
                    <form action="addbrandcontroller" method="post">
                        ...
                        <div class="modal-body">					
                            <div class="form-group">
                                ...
                                <input name="brandname" type="text" class="form-control" required pattern="[a-zA-Z]+" title="Brand name must contain only letters">
                            </div>
                        </div>
