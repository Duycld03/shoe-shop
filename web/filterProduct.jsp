<%-- 
    ...
    Created on : Feb 2, 2024, 7:01:51 PM
        ...
        <div class=" flex md:w-full md:justify-between mt-[20px] h-auto  mt-[20px] md:my-[40px] my-0">
            <div class="slide-bar md:w-[25%] w-[20%] md:ml-[50px] md:mr-0 mr-[10px]">
                ...
                <div
                    ...
                    <div class="hot-deal-content  text-[10px] md:text-[1.2rem]">
                        <div>
                            <a href="#"
                ...
                <div
                    ...
                    <div class="custom-wrapper w-full md:pr-[25px] md:pb-[40px] md:left-[63px] mx-0 md:mx-1">
                        <div class="price-input-container w-full ">
                            ...
                            <div class="md:flex md:justify-between w-full md:justify-items-center">
                                ...
                                <div
                                    ...
                                    <input type="number"
                                           class="min-input text-[7px] w-[20px] md:text-[20px] md:w-[70px] md:mx-[10px] md:h-[30px] md:mx-1 mx-[2px]  border rounded-md"
                                           value="2500">
                                    <p class="md:font-medium text-[10px] md:mx-2 items-center md:text-[20px]">to</p>
                                    <input type="number"
                                           class="max-input text-[7px] w-[20px] md:text-[20px] md:w-[70px] md:mx-[10px] md:h-[30px] md:mx-1 mx-[2px]  border rounded-md"
                                           value="8500">
                                </div>
                            </div>
                            <div class="slider-container  h-[3px] md:h-[5px] relative bg-[#e4e4e4] rounded-[5px] w-auto">
                                <div class="price-slider h-full left-[25%] right-[15%] absolute rounded-[5px] bg-[#05a3e7]">
                                </div>
                            </div>
                        </div>
                        <!-- Slider -->
                ...
                <div class=" text-center bg-[#F6F7F8] flex justify-center items-center w-full md:py-[10px]">
                    <button class="font-bold md:text-[20px] text-[10px]">More</button>
                </div>
            </div>
            <div class="Product-bar md:w-[70%] w-[75%]  md:mx-10 ">
                <div class="Show-Product-bar bg-[#40BFFF] text-white md:flex md:h-[17%] md:mb-7 pb-[20px] mb-5">
                    <div class="md:pl-[100px] pt-3 md:pt-[50px] md:w-full pl-5 relative">
                        ...
                        <p class="font-[400] md:text-[20px] text-[10px]">Performance and design. Taken right to the edge.
                        </p>
                        <div class="md:mt-[50px] mt-[30px] ">
                            <p class="text-[15px] font-medium"><span class="underline decoration-2">SHOP</span> NOW</p>
                        </div>
                    </div>
                ...
                <div class="bg-[#F6F7F8] md:flex md:justify-between w-full h-auto md:mb-7 mb-3 md:pb-0 pb-1 ">
                    <div
                        ...
                        <div class="flex justify-between">
                            <p>Sort By:</p>
                            <select name="Show-Product" id="" class="md:w-[100px] bg-[#F6F7F8] rounded-[5px] md:mx-[10px]">
                        ...
                        <div class="flex justify-between">
                            <p>Show:</p>
                            <select name="Show-Product" id="" class="md:w-[100px] bg-[#F6F7F8] rounded-[5px] mx-[10px]">
                    ...
                    <div class="flex h-auto md:w-[12%] md:justify-center">
                        <div class="h-auto md:py-[25px] py-[5px] m-auto px-[10px] flex justify-center hover:bg-[#D3D4D6]">
                ...
                <div class="Product-list">
                    <div class="flex justify-between md:mb-[30px] mb-3 md:w-full md:full ">
                        <div
                            ...
                            <div class="text-center md:mt-2 mt-1">
                                ...
                                <p class="text-[7px] md:text-[sm] font-medium md:text-base">Lorem ipsum dolor sit amet
                                    consectetur
                                    adipisicing elit.</p>
                                <div class="flex justify-between px-2 pt-2 items-center md:px-[40px] md:pt-[10px]">
                                    <div>
                                        <span class="text-[#40BFFF] font-bold text-[10px] md:text-lg">$299,43</span>
                                    </div>
                                    <div class="flex flex-col md:flex-row">
                                        <span
                                            class="text-[#9098B1] line-through text-[8px] md:text-sm md:text-base">$534,33</span>
                                        <span class="text-[#FB7181] font-bold text-[8px] md:text-sm md:text-base">24%
                                            Off</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    </div>    <div class="flex justify-between md:mb-[30px] mb-3 md:w-full md:full ">
                        <div
                            class="border-solid border-2  w-[33%] md:w-[30%] h-full pb-[10px] md:pb-[20px] md:h-auto  rounded-[5%] relative shadow-lg rounded-sm hover:scale-105 transition-all duration-200 ease-in hover:cursor-pointer">
                            <img src="assets/img/products/image Product1.jpg" class="cm:w-full" />
                            <div class="text-center md:mt-2 mt-1">
                ...
                <div class="bg-[#F6F7F8] w-full md:h-[3%] h-[50px] md:py-6 relative ">
                    <div
                        ...
                        <p class="h-full hover:bg-[#40BFFF] md:py-[10px] py-[10px] md:px-[30px] px-[20px] ">1</p>
                        <p class="h-full hover:bg-[#40BFFF] md:py-[10px] py-[10px] md:px-[30px] px-[20px] ">2</p>
                        <p class="h-full hover:bg-[#40BFFF] md:py-[10px] py-[10px] md:px-[30px] px-[20px] ">3</p>
                        <p class="h-full hover:bg-[#40BFFF] md:py-[10px] py-[10px] md:px-[30px] px-[20px] ">4</p>
                        <p class="h-full hover:bg-[#40BFFF] md:py-[10px] py-[10px] md:px-[30px] px-[20px] ">5</p>
                    </div>
                </div>
            </div>
        </div>
        <%@include file="footer.jsp" %>
        <script src="validation/priceRange.js"></script>
