...
<<<<<<< HEAD
    ...
    <body>
        <div class="w-full max-w-md p-8 space-y-3 rounded-xl mx-auto bg-gray-100 p-6 m-8">
            <h1 class="text-2xl font-bold text-center mb-4">Login</h1>
            <form novalidate="" action="" class="space-y-6">
                <div class="space-y-1 text-sm">
                    <label for="username" class="block">Username</label>
                    <input type="text" name="username" id="username" placeholder="Username" class="w-full px-4 py-3 rounded-md focus:dark:border-violet-400">
                </div>
                <div class="space-y-1 text-sm">
                    <label for="password" class="block">Password</label>
                    <input type="password" name="password" id="password" placeholder="Password" class="w-full px-4 py-3 rounded-md focus:dark:border-violet-400">
...
<body>
    <%@include file="header.jsp" %>
        <div
            class="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 mx-auto bg-gray-100 p-6 m-8">
            <h1 class="text-2xl font-bold text-center mb-4">Login</h1>
            <form novalidate="" action="" class="space-y-6">
                <div class="space-y-1 text-sm">
                ...
                <div class="space-y-1 text-sm">
                    ...
                    <div class="flex justify-end text-xs dark:text-gray-400">
                        <a rel="noopener noreferrer" href="#" class="text-[#40BFFF] font-bold hover:underline">Forgot
                            Password?</a>
>>>>>>> e4edd04198886fedc63d2c2ef42fc8de6683c4fd
                    </div>
                </div>
                <button
            ...
            <div class="flex items-center space-x-4">
                ...
                <p class="text-center text-[14px] font-bold tracking-[0px] font-[Poppins] not-italic leading-[150px]">OR</p>
                <div class="flex-1 h-px bg-[#40BFFF]"></div>
            </div>
...
=======
            <p class="text-xs text-center sm:px-6 dark:text-gray-400">Don't have an account?
                <a rel="noopener noreferrer" href="#"
                    class="text-[#40BFFF] font-bold hover:underline dark:text-gray-100">Sign up</a>
>>>>>>> e4edd04198886fedc63d2c2ef42fc8de6683c4fd
            </p>
        </div>
