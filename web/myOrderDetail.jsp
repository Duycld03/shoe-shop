    ...
    <body>
        ...
        <div class=" md:flex-wrap w-full h-auto md:flex md:justify-evenly md:my-4">
            ...
            <div class="OrderDetail md:w-2/4 rounded-xl my-8 p-10 border-2 border-black-500">
                <div>
                    <div class="Header_Content md:text-3xl md:font-medium md:pb-5">Order history</div>
                    ...
                    <div class="ProductPurches bg-gray-300 rounded-lg">
                        ...
                        <div class="Body md:px-6 pt-3">
                            <div class="product md:flex ">
                                <img class="md:w-52 md:mr-3 md:mb-3" src="assets/img/products/image Product1.jpg" alt="product">
                        ...
                        <div class="footer-order md:flex justify-between justify-items-center md:p-3">
                            <button
