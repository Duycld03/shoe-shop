...
<html>
    ...
    <body>
        ...
        <P>${error}</P>
        <div class=" md:mx-28 md:mx-28 mb- h-auto mx-3 md:mt-28">
            <div class="Product_Infor grid md:grid-cols-2 md:mb-8">
                <div class="Product_Img">
                    <img class="md:w-4/5 md:h-4/6 w-full" src="assets/img/products/${product.primaryImage.imageURL}" alt="img">
                ...
                <div class="product_select grid md:gap-0 gap-5 md:py-0 py-4">
                    ...
                    <div class="flex gap-20 md:items-center md:mb-4 md:mx-2 w-full">
                        <div>
                            <span class="text-[#40BFFF] font-bold text-[10px] text-lg">${product.price - product.price
                                                                                         * (product.discount/100)}</span>
                        </div>
                        <div class="flex flex-row gap-2">
                            <span class="text-[#9098B1] line-through text-[8px] text-base">$${product.price}</span>
                            <span class="text-[#FB7181] font-bold text-[8px]  text-base">${product.discount}%
                                Off</span>
                        </div>
                    </div>
                    ...
                    <div class="numberAndCart flex justify-between md:w-5/6">
                        <div
                            ...
                            <input id="amountInput" min="1" class="amount outline-none bg-gray-200 ml-4 w-1/4"
                                   type="number">
            ...
            <div class="Product_Review bg-gray-200 h-auto pt-5 pb-16 md:mt-28">
                ...
                <div class="InforContent md:px-10 md:text-sm text-gray-500 grid gap-5">
                    <p>air max are always very comfortable fit, clean and just perfect in every way. just the
                        box was too
                        small
                        and scrunched the sneakers up a little bit, not sure if the box was always this small
                        but the 90s
                        are
        ...
        <div class="Relate_Product md:my-16 h-auto mb-10 ">
            ...
            <div class="grid md:grid-cols-4 gap-12 mx-20">
                <c:forEach var="relate" items="${relateP}">
                    <div class="border-solid border-2 h-full pb-[10px] md:pb-[20px] md:h-auto relative shadow-lg rounded-sm hover:scale-105 transition-all duration-200 ease-in hover:cursor-pointer">
                        <img src="assets/img/products/${relate.primaryImage.imageURL}" alt="img" class="w-full" />
                        <div class="text-center md:mt-2 mt-1">
                            <div class="absolute top-0 rounded-[5%] left-0 bg-red-500 w-[70px] text-[17px] text-[8px] px-[10px] py-[5px] font-medium text-white text-center">
                                HOT
                            </div>
                            <p class="text-[10px] md:text-xl font-[700]">${relate.productName}</p>
                            <p class="text-[7px] md:text-[sm] font-medium md:text-base">${relate.description}</p>
                            <div class="flex justify-between px-2 pt-2 items-center md:px-[40px] md:pt-[10px]">
                                <div>
                                    <span class="text-[#40BFFF] font-bold text-[10px] text-lg">${relate.price - relate.price * (relate.discount/100)}</span>
                                </div>
                                <div class="flex flex-row gap-2">
                                    <span class="text-[#9098B1] line-through text-[8px] text-base">${relate.price}</span>
                                    <span class="text-[#FB7181] font-bold text-[8px] text-base">${relate.discount}% Off</span>
                                </div>
                            </div>
                        </div>
                    </div>
