<%-- 
    ...
    Created on : Mar 6, 2024, 11:01:00 PM
                    ...
                    <form action="/updatevariant" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group d-none">
                                <label>ProID</label>
                                <input name="proid" type="text" class="form-control" value="${c.productId}" required>
                            </div>
                            <div class="form-group d-none">
                                <label>VariantID</label>
                                <input name="varid" type="text" class="form-control" value="${c.variantId}" required>
                            </div>
                            <div class="form-group">
                                <label>Color</label>
                                <input name="color" type="text" readonly class="form-control" value="${c.color}" required>
                                <div class="text-danger">${error}</div>
                            </div>
                            <div class="form-group">
                                <label>Size</label>
                                <input name="size" min="1" type="number" readonly class="form-control" value="${c.size}" required
                            ...
                            <div class="form-group">
                                ...
                                <select name="isdelete" class="form-control">
                                    <option value="true" ${c.isDelete() == 'true' ? 'selected' : ''}>true</option>
                                    <option value="false" ${c.isDelete() == 'false' ? 'selected' : ''}>false</option>
                                </select>
                            </div>
                        </div>
